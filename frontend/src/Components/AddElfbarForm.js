...
const AddElfbarForm = ({ onAddElfbar }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            onAddElfbar(response.data);
        } catch (error) {
            alert(`Неверные данные в форме добавления эльфбара! Заполните ее корректно\n${error.message}`);
        }
    }
